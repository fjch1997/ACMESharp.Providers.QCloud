...
@{
	...
	ModuleVersion = '1.0.2'
	GUID = 'A720F8D8-BFDB-4C51-A745-EAA62FAA8EA2'
	
	Author = 'Jingchao Feng'

	Copyright = '(c) 2017 Jingchao Feng. All rights reserved.'	

	Description = "A QCloud dns provider for handling Challenges."
	...
	PrivateData = @{
		...
		PSData = @{
			...
			Tags = @('pki','ssl','tls','security','certificates','letsencrypt','acme','powershell','acmesharp','qcloud','acmesharp_ext')

			# A URL to the license for this module.
			LicenseUri = 'https://raw.githubusercontent.com/fjch1997/ACMESharp.Providers.QCloud/master/LICENSE'

			# A URL to the main website for this project.
			ProjectUri = 'https://github.com/fjch1997/ACMESharp.Providers.QCloud'
	...
	RequiredModules = @(  ## FYI -- If one module uses the Hashtable spec, they all have to
		...
		, @{ModuleName="ACMESharp";ModuleVersion="0.9.1"}
	)
